...
class DetailViewModel: ObservableObject {
    ...
    private func addSubscribers() {
        ...
        coinDetailService.$coinDetails
            .sink { [weak self] details in
                ...
                self?.website = details?.links?.homepage?.first
    ...
    private func mapDataToStatistics(details: CoinDetailModel?, coin: CoinModel) -> (overview: [StatisticModel], additional: [StatisticModel]) {
        let overview: [StatisticModel] = createStatsForOverview(coin: coin)
        let additional: [StatisticModel] = createStatsForAdditional(details: details, coin: coin)
        
        return (overview, additional)
    }
    
    func createStatsForOverview(coin: CoinModel) -> [StatisticModel] {
    ...
    func createStatsForAdditional(details: CoinDetailModel?, coin: CoinModel) -> [StatisticModel] {
